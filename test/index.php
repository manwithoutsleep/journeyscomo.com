...
<section class="home-page">
  ...
  <section class="sidebar">
    ...
    <article class="side-text video">
      <div><input type="submit" name="MakeAppointmentCheryl" id="MakeAppointmentCheryl" value="Click To Make An Appointment" onclick='setAppointmentFields(this.form, "<?php echo $PractitionerIdCheryl ?>"); this.form.submit();' /></div>
      <video controls>
